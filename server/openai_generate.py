...
def generate_children_book_phrases(user_input):
    ...
    message = f"Generate a 2 phrases story paragraph for a children's book based on the following input (character's shouldn't have names, simple story for children to read): {user_input}"
